...
public class BlockingQueueTest01 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.printf("%s added the name %s%n", Thread.currentThread().getName(), bq.peek());
    ...
    static class RemoveFromQueue implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                System.out.printf("%s removing from queue%s%n", Thread.currentThread().getName(), bq.take());
