...
//        searchPricesAsyncFuture(storeService);
    ...
    private static void searchPricesAsyncFuture(StoreService storeService) {
        ...
        Future<Double> pricesAsyncFuture1 = storeService.getPriceAsyncFuture("Store 1");
        Future<Double> pricesAsyncFuture2 = storeService.getPriceAsyncFuture("Store 2");
        Future<Double> pricesAsyncFuture3 = storeService.getPriceAsyncFuture("Store 3");
        Future<Double> pricesAsyncFuture4 = storeService.getPriceAsyncFuture("Store 4");
        ...
        System.out.printf("Time passed to searchPricesAsyncFuture: %d ms\n", end - start);
    ...
    private static void searchPricesAsyncCompletableFuture(StoreService storeService) {
        ...
        System.out.printf("Time passed to searchPricesAsyncCompletableFuture: %d ms\n", end - start);
    }
}
